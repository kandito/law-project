 ...
 * 
 */
@WebServiceClient(name = "service", targetNamespace = "http://WS/", wsdlLocation = "http://exes.cloudapp.net/service?wsdl")
    ...
    extends javax.xml.ws.Service
{
    ...
    private final static QName SERVICE_QNAME = new QName("http://WS/", "service");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://exes.cloudapp.net/service?wsdl");
    ...
    public exes.ws.Service getServicePort() {
     ...
     */
    @WebEndpoint(name = "servicePort")
    public exes.ws.Service getServicePort(WebServiceFeature... features) {
